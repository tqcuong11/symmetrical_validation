...
public class SymmetricalNumberClientGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SymmetricalNumberClientGUI frame = new SymmetricalNumberClientGUI();
	 ...
	 * Create the frame.
	 */
	public SymmetricalNumberClientGUI() {
		setTitle("Client");
